    ...
    <div className="p-4 bg-gray-800 rounded-3xl border  border-gray-800 shadow-sm">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <div className="relative flex-1 sm:flex-none">
            ...
            <input
              ...
              className="w-full sm:w-64 pl-9 pr-4 py-2.5 bg-gray-900 border  border-gray-800 rounded-xl focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 outline-none transition-all text-sm font-medium"
            />
          </div>
          <button
            onClick={() => {
            ...
            <tbody className="divide-y divide-gray-50">
              {currentUsers.map((user, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider border border-gray-700 ${user.role === "trainer"
      ...
      <div className="grid grid-cols-1 gap-4 md:hidden">
        ...
        {currentUsers.map((user) => (
          <div
            key={user.id}
            className="bg-gray-800 p-5 rounded-2xl border  border-gray-800 shadow-sm flex flex-col gap-4"
          >
            <div className="flex justify-between items-start gap-3">
              <div className="flex items-center gap-3">
                <div>
                  <h3 className="font-bold text-gray-200 text-lg">{user.name}</h3>
                  <span
                    className={`inline-block mt-1 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider border border-gray-700 ${user.role === "trainer"
                      ? "bg-blue-500 text-white border-blue-100"
                      : "bg-amber-600 text-white border-amber-100"
                      }`}
                  >
        ...
        <div className="flex items-center justify-between mt-6 px-2 py-4 border-t border-gray-50">
          ...
          <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            <p className="text-sm text-gray-400 font-medium">
              ...
              de <span className="text-gray-200 font-bold">{filteredUsers.length}</span> miembros
            </p>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/50 backdrop-blur-md animate-in fade-in duration-300 p-4">
          <div className="bg-gray-800 rounded-3xl shadow-2xl w-full max-w-md overflow-hidden border  border-gray-800 flex flex-col animate-in zoom-in-95 duration-200">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={saving}
                    className="w-full pl-11 pr-4 py-3.5 bg-gray-900 border border-gray-800 rounded-2xl focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 outline-none transition-all text-sm font-medium disabled:opacity-60"
                    value={formData.name}
