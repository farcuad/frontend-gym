...
function VerifyMembership() {
    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-slate-50 via-gray-50 to-slate-100 flex items-center justify-center p-4">
        <div className="w-full max-w-sm">
          <div className="bg-gray-800 rounded-3xl shadow-xl p-8 animate-pulse space-y-6">
            {/* Icon skeleton */}
            ...
            <div className="space-y-2">
              <div className="h-6 bg-gray-700 rounded-lg mx-auto w-3/4" />
              <div className="h-4 bg-gray-700 rounded-lg mx-auto w-1/2" />
            </div>
            {/* Rows skeleton */}
            <div className="space-y-4 pt-2">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="flex items-center gap-3">
                  <div className="w-9 h-9 bg-gray-700 rounded-xl shrink-0" />
        ...
        <div className="w-full max-w-sm">
          <div className="bg-gray-800 rounded-3xl shadow-xl overflow-hidden">
            ...
            <div className="bg-linear-to-r from-amber-400 to-orange-400 px-6 py-8 text-center">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gray-800/20 backdrop-blur-sm mb-4">
                <FontAwesomeIcon
  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center p-4 transition-colors ${isValid
    ...
    >
      <div className="w-full max-w-sm">
        <div className="bg-gray-800 rounded-3xl shadow-xl overflow-hidden">
          {/* ── Status Header ── */}
          <div
            className={`px-6 py-8 text-center transition-colors ${isValid
          ...
          >
            {/* Animated icon ring */}
            <div
              className={`inline-flex items-center justify-center w-22 h-22 rounded-full mb-4 ${isValid ? "bg-gray-800/20" : "bg-gray-800/20"
          ...
          <div className="px-6 pb-6">
            <button
              onClick={() => window.close()}
              className={`w-full py-3.5 px-4 rounded-xl text-white text-sm font-bold active:scale-[0.98] transition-all shadow-lg ${isValid
...
function DataRow({ icon, label, value, accent }: DataRowProps) {
  const iconBg =
    accent === "teal"
      ? "bg-teal-900/30 text-teal-600"
      : "bg-red-50 text-red-500";

  return (
    <div className="flex items-center gap-3.5 py-3 border-b border-gray-800 last:border-0">
      <div
