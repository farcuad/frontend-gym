      ...
      {open && (
        <div className="md:hidden bg-white border-t border-gray-100 px-6 py-4 space-y-3">
          ...
          <div className="flex gap-3 pt-2">
            <button className="flex-1 py-2 text-sm font-semibold rounded-xl text-teal-700 bg-teal-50">Iniciar sesión</button>
            <button className="flex-1 py-2 text-sm font-semibold rounded-xl text-white" style={{ background: `linear-gradient(135deg, ${P}, ${PD})` }}>Registrarse</button>
          </div>
        </div>
      )}
    </header>
